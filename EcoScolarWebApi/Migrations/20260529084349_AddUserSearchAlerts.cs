...
{
    /// <inheritdoc />
    public partial class AddUserSearchAlerts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "UserSearchAlerts",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSearchAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSearchAlerts_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSearchAlerts_UserId",
