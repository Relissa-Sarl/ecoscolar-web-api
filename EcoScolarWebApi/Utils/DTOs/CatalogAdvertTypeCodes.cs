...
/// <summary>
/// Chaînes identiques au champ <c>type</c> de <see cref="EcoscolarWebApi.Utils.DTOs.Adverts.AdvertReadDto"/> (mapping dans <c>FromEntity</c>, fichier Adverts/AdvertDto.cs).
